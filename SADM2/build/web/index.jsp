...
<html>
    <%
        ...
        Pagina paginax = new Pagina();
        
        if(null != request.getParameter("id_html")){
          
       paginax = consultas.obtPaginasbyIdHtml(request.getParameter("id_html"));
        }
        if (null == paginax.getId_Pagina()) {
            paginax = consultas.obtPaginasbyIdHtml("inicio_f");
             } 
    %>
    <head>
        <meta charset="utf-8"/>
        <title><%=paginax.getPagina_desc()%></title>
    ...
    <body data-ix="show-up-on-load" class="body">
                       ...
                       <!-- <div class="div-block-8">
                        ...
                        <div >
                            ...
                            <a href="index.jsp" data-ix="fade-out-on-click" class="brand w-nav-brand w--current" style="margin-left: 90px;">
                                <img src="archivos/uploaded_files/5b6b5f504c3819038b156e33_logo_sadm.png"  sizes="220px" alt="" class="image-11"></a>
        ...
        <form id="FormContentIndex" name="FormContentIndex">
            <br><br>
            <div>
                ...
                <div class="flex-wrapper footer-vertical">
                    ...
                    <div class="footer-social-links">
                        <%                             
                            ...
                            for (Menu men_fs : lstaMenu_fs) {
                                //System.out.println("menu_fs::"+ men.getNombre()+" :: " + men.getTarget() );
                                href_fs = men_fs.getHref();
                                //System.out.println("target1 :: " + men.getTarget() );
                                target_fs = men_fs.getTarget();
                                val2_fs = men_fs.getVal2();
                                valor_fs = men_fs.getVal3();
                                String quote_fs = "\"";
